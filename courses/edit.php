...
if (isset($_POST['submit'])) { //als de knop geklikt is voer de onderstaande code uit
    ...
    $id = $_POST['id']; // vul een variabele die bij id is ingevuld

    $sql = "UPDATE courses SET name = :ph_name, price = :ph_price WHERE id = :ph_id "; //update sql
    $stmt = $db_conn->prepare($sql); //stuur naar mysql.
    $stmt->bindParam(":ph_name", $name); //verbind de drie variabelen uit het formulier met de placeholders
...
<head>
    ...
    <title>Zeilschool PDO - Edit Cursus</title>
</head>
        ...
        <div class="col">
            ...
            <form method="post" action="">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" aria-describedby="nameHelp" name="name" value="<?php echo $course['name'] ?>">
                    <small id="namelHelp" class="form-text text-muted">Vul een naam hier in</small>
                </div>
                <div class="form-group">
                    <label for="price">Prijs</label>
                    <input type="number" class="form-control" id="price" name="price" value="<?php echo $course['price'] ?>">
                </div>
